...
func CalculateTSNEFrameByFrame(hand, controller *regexp.Regexp, directory *string, iterations int, successfulOnly bool, results *Results) {
	fmt.Println("Calculating TSNE")
	filename := "frame.to.frame.covariance.csv"
	...
	WriteCSVFloat("/Users/zahedi/Desktop/frame.to.frame.data.csv", data)
